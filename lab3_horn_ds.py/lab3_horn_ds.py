...
# -----------------------------
# Вихідні дані (варіант 10)
# -----------------------------
lam = 0.034   # довжина хвилі, м (3.4 см)
ap  = 0.13    # розмір розкриву в H-площині, м
bp  = 0.13    # розмір розкриву в E-площині, м
...
plt.title("ДС пірамідального рупору в площині E (варіант 10)")
...
plt.title("ДС пірамідального рупору в площині H (варіант 10)")
plt.xlabel("Кут θ, градуси")
