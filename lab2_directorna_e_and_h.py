...
# from scipy.signal import argrelextrema # Не використовується, можна видалити

# ==========================================================
# ВХІДНІ ДАНІ ДЛЯ ВАРІАНТА №10
# F = 600 МГц, N = 7
# ==========================================================
N = 7  # Число елементів антени
F = 600 * 10 ** 6  # Частота (600 МГц)
...
plt.title(f'Нормовані ДС Директорної антени (Варіант 10: $N={N}, F=600 \text{{ МГц}}$)', fontsize=12)
...
fig.savefig(f"ДС_Director_Var10_N{N}_F600.jpg", dpi=600)
plt.show()